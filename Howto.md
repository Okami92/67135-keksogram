...
```bash
git clone git@github.com:js-htmlacademy/keksogram.git
```

Адрес в команде нужно заменить на тот, что вы скопировали. Теперь в папке `keksogram` лежит ваш проект.
...
git remote add upstream git@github.com:js-htmlacademy/67135-keksogram.git
```
